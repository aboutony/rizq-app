...
export default function BookingStatus({ params }: Params) {
  ...
  const t = {
en: { title:'Booking Status', note:'Your booking is confirmed.', back:'Go Back' },
    ar: { title:'حالة الحجز', note:'تم تأكيد الحجز.', back:'رجوع' },
    fr: { title:'Statut de réservation', note:'Votre réservation est confirmée.', back:'Retour' }
  }[locale as 'en'|'ar'|'fr'];
