...
export default function ConfirmPage({ params }: Params) {
  const locale = ['en','ar','fr'].includes(params?.locale || '') ? params!.locale! : 'en';

  const t = {
    en: { title:'Confirm Lesson', note:'Review details before confirming.', confirm:'Confirm', back:'Go Back' },
    ar: { title:'تأكيد الدرس', note:'راجع التفاصيل قبل التأكيد.', confirm:'تأكيد', back:'رجوع' },
    fr: { title:'Confirmer le cours', note:'Vérifiez les détails avant de confirmer.', confirm:'Confirmer', back:'Retour' }
  }[locale as 'en'|'ar'|'fr'];
