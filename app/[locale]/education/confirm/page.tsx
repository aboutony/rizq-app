...
export default function ConfirmBooking({ params }: Params) {
  ...
  const t = {
    en: { title:'Confirm Booking?', confirm:'Confirm', cancel:'Cancel', reconfirm:'Reconfirm' },
    ar: { title:'تأكيد الحجز؟', confirm:'تأكيد', cancel:'إلغاء', reconfirm:'إعادة تأكيد' },
    fr: { title:'Confirmer la réservation ?', confirm:'Confirmer', cancel:'Annuler', reconfirm:'Reconfirmer' }
  }[locale as 'en'|'ar'|'fr'];
  ...
  <div class="wrap">
    <div class="card">
      ...
      <div style="margin-top:14px">
        ...
        <a class="btn ghost" href="/${locale}/education/student/lesson">${t.cancel}</a>
      </div>
    </div>
  </div>
  `;
