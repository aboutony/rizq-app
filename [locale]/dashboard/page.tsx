          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 rounded-2xl flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-slate-700">Client Libanais</p>
                  <p className="text-sm text-slate-500">Mathématiques • Terminale</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
          ...
          <div className="flex items-center gap-4">
            <div className="text-center bg-cyan-50 p-2 rounded-xl min-w-[60px]">
              <p className="text-xs uppercase text-cyan-600 font-bold">Fév</p>
              <p className="text-xl font-bold text-cyan-700">04</p>
            </div>
            <p className="font-medium text-slate-700">Cours de Français</p>
          </div>
        </div>
