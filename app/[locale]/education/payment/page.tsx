...
export default function PaymentPage({ params }: Params) {
  ...
  const t = {
    en: { title:'Payment', note:'Complete payment to proceed.', pay:'Pay Now', back:'Go Back' },
    ar: { title:'الدفع', note:'أكمل الدفع للمتابعة.', pay:'ادفع الآن', back:'رجوع' },
    fr: { title:'Paiement', note:'Terminez le paiement pour continuer.', pay:'Payer maintenant', back:'Retour' }
  }[locale as 'en'|'ar'|'fr'];
