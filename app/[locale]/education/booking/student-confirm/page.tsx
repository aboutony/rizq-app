...
export default function StudentConfirm({ params }: Params) {
  ...
  const t = {
    en: {
      title:'Student/Parent Confirmation',
      note:'Student/Parent confirms logistics (equipment + venue) before payment.',
      confirm:'Confirm Logistics',
      back:'Go Back'
    },
    ar: {
      title:'تأكيد الطالب/ولي الأمر',
      note:'يقوم الطالب/ولي الأمر بتأكيد اللوجستيات (المعدات + المكان) قبل الدفع.',
      confirm:'تأكيد اللوجستيات',
      back:'رجوع'
    },
    fr: {
      title:'Confirmation élève/parent',
      note:'L’élève/parent confirme la logistique (matériel + lieu) avant le paiement.',
  ...
  <div class="wrap">
    <div class="card">
      ...
      <a class="btn" href="/${locale}/education/booking/tutor-confirm">${t.confirm}</a>
