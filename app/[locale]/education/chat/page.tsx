...
export default function ChatPage({ params }: Params) {
  ...
  const t = {
    en: { title:'Payment Chat', hint:'Type a message…', send:'Send', back:'Go Back' },
    ar: { title:'محادثة الدفع', hint:'اكتب رسالة…', send:'إرسال', back:'رجوع' },
    fr: { title:'Chat paiement', hint:'Écrire un message…', send:'Envoyer', back:'Retour' }
  }[locale as 'en'|'ar'|'fr'];
  ...
  <style>
    ...
    .bubble{padding:10px;border-radius:12px;border:1px solid var(--border);margin:8px 0}
  ...
  <div class="wrap">
    <div class="card">
      ...
      <div class="bubble"><strong>Student:</strong> I sent the transfer.</div>
      <div class="bubble"><strong>Tutor:</strong> Please share the receipt.</div>
